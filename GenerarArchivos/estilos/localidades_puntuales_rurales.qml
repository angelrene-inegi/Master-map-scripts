...
<qgis simplifyLocal="1" styleCategories="AllStyleCategories" minScale="1e+08" hasScaleBasedVisibilityFlag="0" simplifyAlgorithm="0" readOnly="0" version="3.10.1-A Coruña" maxScale="0" simplifyDrawingTol="1" labelsEnabled="0" simplifyMaxScale="1" simplifyDrawingHints="1">
  ...
  <aliases>
    ...
    <alias field="nomgeo" name="" index="7"/>
    <alias field="plano" name="" index="8"/>
  ...
  <defaults>
    ...
    <default field="plano" expression="" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint field="plano" unique_strength="0" constraints="0" notnull_strength="0" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint field="plano" exp="" desc=""/>
