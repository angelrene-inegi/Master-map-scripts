...
<qgis simplifyLocal="1" styleCategories="AllStyleCategories" minScale="1e+08" hasScaleBasedVisibilityFlag="0" simplifyAlgorithm="0" readOnly="0" version="3.10.1-A Coruña" maxScale="0" simplifyDrawingTol="1" labelsEnabled="0" simplifyMaxScale="1" simplifyDrawingHints="1">
  ...
  <aliases>
    ...
    <alias field="id_km" name="" index="1"/>
    <alias field="km" name="" index="2"/>
    <alias field="fecha_act" name="" index="3"/>
    <alias field="calirepr" name="" index="4"/>
    <alias field="gdb_geomattr_data" name="" index="5"/>
  </aliases>
  <excludeAttributesWMS/>
  <excludeAttributesWFS/>
  <defaults>
    <default field="objectid" expression="" applyOnUpdate="0"/>
    <default field="id_km" expression="" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint field="id_km" unique_strength="0" constraints="0" notnull_strength="0" exp_strength="0"/>
    <constraint field="km" unique_strength="0" constraints="0" notnull_strength="0" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint field="id_km" exp="" desc=""/>
