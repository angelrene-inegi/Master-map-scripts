...
<qgis simplifyLocal="1" styleCategories="AllStyleCategories" minScale="1e+08" hasScaleBasedVisibilityFlag="0" simplifyAlgorithm="0" readOnly="0" version="3.10.1-A Coruña" maxScale="0" simplifyDrawingTol="1" labelsEnabled="0" simplifyMaxScale="1" simplifyDrawingHints="1">
  ...
  <aliases>
    ...
    <alias field="id_puente" name="" index="1"/>
    <alias field="nombre" name="" index="2"/>
    <alias field="tipo" name="" index="3"/>
    <alias field="material" name="" index="4"/>
    <alias field="fecha_act" name="" index="5"/>
    <alias field="calirepr" name="" index="6"/>
  ...
  <defaults>
    ...
    <default field="id_puente" expression="" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint field="id_puente" unique_strength="0" constraints="0" notnull_strength="0" exp_strength="0"/>
    ...
    <constraint field="material" unique_strength="0" constraints="0" notnull_strength="0" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint field="id_puente" exp="" desc=""/>
