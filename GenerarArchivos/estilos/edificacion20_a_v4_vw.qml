...
<qgis simplifyLocal="1" styleCategories="AllStyleCategories" minScale="1e+08" hasScaleBasedVisibilityFlag="0" simplifyAlgorithm="0" readOnly="0" version="3.10.1-A Coruña" maxScale="0" simplifyDrawingTol="1" labelsEnabled="0" simplifyMaxScale="1" simplifyDrawingHints="1">
  ...
  <renderer-v2 type="singleSymbol" symbollevels="0" enableorderby="0" forceraster="0">
    <symbols>
      <symbol type="fill" name="0" alpha="0.605" clip_to_extent="1" force_rhr="0">
  ...
  <aliases>
    ...
    <alias field="cali_repr" name="" index="2"/>
    <alias field="carta" name="" index="3"/>
    <alias field="identifica" name="" index="4"/>
    <alias field="codigo" name="" index="5"/>
    <alias field="version" name="" index="6"/>
  ...
  <constraints>
    ...
    <constraint field="version" unique_strength="0" constraints="0" notnull_strength="0" exp_strength="0"/>
